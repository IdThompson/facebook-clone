    ...
    <div class="header__right">
        <div class="header__info">
            <img class="user__avatar"
                 ...
                 alt=""/>
            <a id="my-name" href="<%=request.getContextPath()%>/userWall.jsp">${user.userName}</a>
        </div>
...
<%--content-body--%>
<%--<form action="<%=request.getContextPath()%>/saveEdited" method="post">--%>
<%--    <textarea name="edited-post" >${updatePost.content}</textarea>--%>
<%--    <input type="hidden" name="id" value="${updatePost.postId}">--%>
...
<div class="messageSender__top">
    <img
            ...
            alt=""
    />
    <form method="post" action="<%=request.getContextPath()%>/saveEdited" id="post-content" method="post">
        <div class="mb-3" style="width: 100%;">
            <textarea style="width: 60%; height: 30vh;" class="form-control messageSender__input" name="edited-post" rows="3">${updatePost.content}</textarea>
            <input type="hidden" name="id" value="${updatePost.postId}">
        </div>
        <input class="form-control btn btn-primary" style="width: 100px;" type="submit"  value="Edit&Save">
